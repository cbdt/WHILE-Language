...
public class WhileLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected WhileLanguageGrammarAccess grammarAccess;
	protected AbstractElementAlias match_ExprEq_SYMBOLTerminalRuleCall_1_1_q;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (WhileLanguageGrammarAccess) access;
