 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.comp.wh.wh.Nop#getNop <em>Nop</em>}</li>
 * </ul>
 *
 * @see org.xtext.comp.wh.wh.WhPackage#getNop()
 * @model
 * @generated
 */
public interface Nop extends EObject
{
   ...
   * @see #setNop(String)
   * @see org.xtext.comp.wh.wh.WhPackage#getNop_Nop()
   * @model
   * @generated
   */
  String getNop();
  ...
  /**
   * Sets the value of the '{@link org.xtext.comp.wh.wh.Nop#getNop <em>Nop</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
