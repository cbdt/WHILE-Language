...
import org.xtext.ide.contentassist.antlr.internal.InternalWhileLanguageParser;
...
public class WhileLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, WhileLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getProgramAccess().getFAssignment_0(), "rule__Program__FAssignment_0");
			builder.put(grammarAccess.getProgramAccess().getPAssignment_1_1(), "rule__Program__PAssignment_1_1");
